...
public class prisonersDilemma {
    ...
    public void startGame() {
        boolean gameOn = true;
        for(int round=1; round<=rounds; round++) { // loop through rounds
            // System.out.print('\u000C'); // clear screen
    ...
    public void titForTat(int round) {
        // A strategy that always does the opposite of what the player put last round, and cooperates on the first round
        if (playerHistory[round-1] == "c") {
            AIHistory[round] = "d";
        } else {
            AIHistory[round] = "c";
        }
    ...
    public void roundComplete(int round) {
        ...
        System.out.println();
        System.out.println(playerHistory[round]);
        ...
        if(AIHistory[round].equals("c")) { // ai history
            System.out.println("The AI cooperated - " + "+" + playerPointsHistory[round] + " points"); // if ai cooperated
        } else {
            System.out.println("The AI defected - " + "+" + playerPointsHistory[round] + " points"); // if player defected
        }
